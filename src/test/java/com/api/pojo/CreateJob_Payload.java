...
public class CreateJob_Payload {
	 private int mst_service_location_id;
		...
		public CreateJob_Payload(int mst_service_location_id, int mst_platform_id, int mst_warrenty_status_id,
		...
		public String toString() {
			return "CreateJob_Payload [mst_service_location_id=" + mst_service_location_id + ", mst_platform_id="
					+ mst_platform_id + ", mst_warrenty_status_id=" + mst_warrenty_status_id + ", mst_oem_id="
					+ mst_oem_id + ", customer=" + customer + ", customer_address=" + customer_address
					+ ", customer_product=" + customer_product + ", problems=" + problems + "]";
		}
